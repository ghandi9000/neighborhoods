...
##
################################################################################
source("functions/functions-neighborhood.R")
source("neighborhoods/surround/functions.R")
source("neighborhoods/surround/visuals/functions-graphics.R")
source("neighborhoods/surround/visuals/functions-interactive.R")
...
dump(list=c("pnum","yr","nsize","C","alpha","beta","theta","NM","nsis"),
  file="neighborhoods/surround/visuals/rstudio/data.R")
